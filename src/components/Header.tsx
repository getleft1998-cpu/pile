      ...
      <div className="bg-black text-white text-xs py-2 hidden sm:block">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
          <div className="flex items-center gap-6 overflow-hidden">
            <span className="whitespace-nowrap">Free delivery on orders over 99 TND</span>
            <span className="text-gray-400">|</span>
            <span className="whitespace-nowrap">Secure Payment</span>
            <span className="text-gray-400">|</span>
            <span className="whitespace-nowrap">Tunisia&apos;s Official Flormar Store</span>
          </div>
          <div className="flex items-center gap-4 shrink-0">
            <Link href="/about" className="hover:text-brand transition-colors whitespace-nowrap">About Us</Link>
            <Link href="/contact" className="hover:text-brand transition-colors whitespace-nowrap">Contact Us</Link>
            <Link href="/track" className="hover:text-brand transition-colors whitespace-nowrap">Track Order</Link>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-1 shrink-0">
              <span className="text-2xl font-black tracking-tight text-brand">FLORMAR</span>
            ...
            <div className="flex items-center gap-2">
              <button
                className="hidden md:flex p-2 text-gray-700 hover:text-brand transition-colors"
                aria-label="Search"
              >
                <Search size={20} />
              </button>
            ...
            <nav className="max-w-7xl mx-auto px-4 py-4 flex flex-col gap-1">
              {NAV_LINKS.map((l) => (
                <Link
                  key={l.label}
                  href={l.href}
                  className="text-sm font-medium text-gray-700 hover:text-brand transition-colors py-2 border-b border-gray-50 last:border-0"
                  onClick={() => setOpen(false)}
                >
                  {l.label}
                </Link>
              ))}
              <div className="pt-4 border-t border-gray-100 mt-2 flex flex-col gap-2 text-xs text-gray-500">
